...
export function APYCalculator() {
  ...
  const results = calc()
  const earningsPerSecond = results.rawEarnings / (stakeDuration * 24 * 60 * 60)
  ...
  const displayEarnings = liveMode ? liveEarnings.toFixed(2) : results.earnings
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '9px', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.25)', marginBottom: '8px' }}>
                {liveMode ? 'LIVE_EARNINGS' : 'TOTAL_EARNINGS'}
              </div>
              <div style={{
